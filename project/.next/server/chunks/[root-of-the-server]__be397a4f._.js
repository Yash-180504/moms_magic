module.exports = [
"[project]/project/.next-internal/server/app/api/admin/data/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/project/app/api/admin/data/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const roleErr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRole"])(payload, 'admin');
    if (roleErr) return roleErr;
    try {
        const usersRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id, name, email, role, created_at FROM users ORDER BY created_at DESC LIMIT 200');
        const providersRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT p.*, u.name AS owner_name, u.email AS owner_email
       FROM providers p
       JOIN users u ON u.id = p.user_id
       ORDER BY p.created_at DESC LIMIT 200`);
        const ordersRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT o.*, p.kitchen_name, u.name AS customer_name, u.email AS customer_email
       FROM orders o
       JOIN providers p ON p.id = o.provider_id
       JOIN users u ON u.id = o.customer_id
       ORDER BY o.created_at DESC LIMIT 200`);
        const salesRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT COALESCE(SUM(total_amount),0) AS total_sales, COUNT(*) AS total_orders FROM orders');
        const activeProvidersRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT COUNT(*) AS active_providers FROM providers WHERE is_active = TRUE');
        const customerRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT COUNT(*) AS total_customers FROM users WHERE role = 'customer'");
        return __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            users: usersRes.rows,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$project$2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["err"])(error.message || 'Failed to load admin data', 500);
    }
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be397a4f._.js.map