...
export default function AddressBook({
  triggerLabel = "Address Book",
  triggerClassName = "flex items-center gap-2 text-sm font-semibold text-[#0F172A] bg-[#FDF4F0] border border-[#FCEAE1] rounded-xl px-3 py-2 hover:border-[#EA580C] transition-all cursor-pointer",
  onOpen,
}) {
  const { user } = useAuth();
