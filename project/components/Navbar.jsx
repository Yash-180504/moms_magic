    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 h-14 md:h-16">
          ...
          <div className="hidden md:flex flex-1 items-center gap-2 bg-[#FFF7ED] border border-[#FCEAE1] rounded-xl px-3 py-2 focus-within:border-[#EA580C] focus-within:ring-2 focus-within:ring-[#EA580C]/20 transition-all">
            <Search
              size={15}
          ...
          >
            ...
            {user ? (
              <>
                ...
                <AddressBook onOpen={() => setUserMenuOpen(false)} />
              </>
            ) : (
              <>
                <Link
