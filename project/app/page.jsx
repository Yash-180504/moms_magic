    ...
    <div className="min-h-screen flex flex-col bg-[#FFF7ED]">
      ...
      <main id="main-content">
        ...
        <section
          ...
          style={{ backgroundImage: 'url(/hero_background.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center' }}
        ...
        >
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <h1 id="hero-heading" className="font-heading font-bold text-4xl sm:text-5xl lg:text-6xl text-[#f8f8fa] leading-tight mb-4">
              Taste of home, <br />
        ...
        {/* Provider listings */}
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12" aria-labelledby="kitchens-heading">
          ...
          <div className="flex gap-2 overflow-x-auto pb-3 mb-6 scrollbar-none" role="group" aria-label="Filter by category">
            {CATEGORIES.map(cat => (
              <button
                key={cat.id}
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
              {providerList.map(provider => <ProviderCard key={provider.id} provider={provider} />)}
            </div>
          ) : (
        ...
        {/* Provider CTA */}
        <section className="bg-gradient-to-r from-[#EA580C] to-[#F97316] py-14 px-4 sm:px-6 lg:px-8" aria-labelledby="provider-cta-heading">
