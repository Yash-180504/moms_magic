      ...
      <div className="min-h-screen flex flex-col bg-[#FFF7ED]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 px-4 py-16">
          ...
          <div className="flex gap-3">
            <Link
              href="/login"
              className="bg-[#EA580C] text-white font-semibold px-6 py-3 rounded-xl hover:bg-[#C2410C] transition-colors text-sm"
            >
              Log in
            </Link>
            <Link
              href="/register"
              className="border-2 border-[#EA580C] text-[#EA580C] font-semibold px-6 py-3 rounded-xl hover:bg-[#FFF7ED] transition-colors text-sm"
            >
              Sign up
            </Link>
          </div>
      ...
      <main className="flex-1 max-w-lg mx-auto w-full px-4 py-8 pb-6">
        ...
        <div className="bg-white rounded-2xl border border-[#FCEAE1] p-6 mb-4 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-heading font-bold text-xl text-[#0F172A] truncate">
              {user.name}
            </h1>
            ...
            <div className="flex items-center gap-3 px-5 py-3.5">
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-[#0F172A]">
                  {user.phone || (
                    <span className="text-[#64748B] italic">Not set</span>
                  )}
                </p>
              </div>
            </div>
        ...
        <div className="md:hidden bg-white rounded-2xl border border-[#FCEAE1] p-5 mb-4">
          ...
          <AddressBook
            triggerLabel="Manage addresses"
            triggerClassName="w-full flex items-center justify-center gap-2 bg-[#EA580C] text-white font-semibold py-2.5 rounded-xl hover:bg-[#C2410C] transition-colors cursor-pointer"
          />
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#FCEAE1] mb-4 overflow-hidden">
          ...
          >
            ...
            <ChevronRight
              size={16}
              className={`text-[#64748B] transition-transform ${pwOpen ? "rotate-90" : ""}`}
            />
          </button>
          {pwOpen && (
            <form
              onSubmit={changePassword}
              className="px-5 pb-5 space-y-3 border-t border-[#FCEAE1] pt-4"
            >
              {[
        ...
        <div className="bg-white rounded-2xl border border-[#FCEAE1] divide-y divide-[#FCEAE1] mb-4 overflow-hidden">
          {user.role === "customer" && (
            <Link
              href="/orders"
              className="flex items-center gap-3 px-5 py-4 hover:bg-[#FDF4F0] transition-colors"
            >
