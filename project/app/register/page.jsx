...
function RegisterForm() {
  ...
  const [form, setForm] = useState({
    ...
    password: "",
    phone: "",
    role: ["provider", "delivery_partner"].includes(searchParams.get("role"))
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#FCEAE1] shadow-sm p-8">
          ...
          <p className="text-sm text-[#64748B] mb-6">
            Start ordering home-cooked meals today
          </p>

          <div
            className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-6 p-1 bg-[#FDF4F0] rounded-xl"
            role="group"
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            >
              {loading
                ? "Creating account…"
                : `Create ${form.role === "provider" ? "Cook" : form.role === "delivery_partner" ? "Delivery Partner" : "Customer"} Account`}
            </button>
          </form>
