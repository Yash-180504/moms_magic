    ...
    <div className="min-h-screen bg-[#FFF7ED] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#FCEAE1] shadow-sm p-8">
          <h1 className="font-heading font-bold text-2xl text-[#0F172A] mb-1">Welcome back</h1>
          <p className="text-sm text-[#64748B] mb-6">Log in to order your daily meals</p>
          ...
          <p className="text-center text-sm text-[#64748B] mt-6">
            ...
            <Link href="/register" className="text-[#EA580C] font-semibold hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
