    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 h-14 md:h-16">
          ...
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2 shrink-0" aria-label="Mom's Magic home">
          ...
          {/* Desktop auth — hidden on mobile (BottomNav handles it) */}
          <nav className="hidden md:flex items-center gap-2 shrink-0" aria-label="Account navigation">
            {!user && (
              <Link
